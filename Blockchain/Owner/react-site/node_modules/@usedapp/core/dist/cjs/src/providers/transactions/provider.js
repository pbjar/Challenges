...
function TransactionProvider(_a) {
    ...
    var _c = hooks_1.useLocalStorage('transactions'), storage = _c[0], setStorage = _c[1];
    ...
    var addNotification = context_2.useNotificationsContext().addNotification;
    ...
    return jsx_runtime_1.jsx(context_3.TransactionsContext.Provider, { value: { transactions: transactions, addTransaction: addTransaction }, children: children }, void 0);
}
